...
def update_plots(attr, old, new):
    ...
    median_source.data = dict(filtered_median_valeur)
...
# Line plot for sum of valeur by year for selected filliere
...
# Bar plot for sum of valeur of selected filliere by year
filliere_bar_plot = figure(title="Sum of Valeur of Selected Filière by Year", x_axis_label='Year', y_axis_label='Sum Valeur')
...
# Line plot for sum of valeur by year for selected produit
...
# Bar plot for sum of valeur of selected produit by year
produit_bar_plot = figure(title="Sum of Valeur of Selected Produit by Year", x_axis_label='Year', y_axis_label='Sum Valeur')
